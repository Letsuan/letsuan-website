export const heroSlides = [
  ...
  },
  {
    ...
    subtitleLine1: '我們設計讓人走進體驗的空間，',
    subtitleLine2: '而非只用眼睛觀看的空間。',
    ctaLabel: '關於我們',
    href: './about',
...
export const services = [
  ...
  { id: 'construction', title: '工程建造', desc: '設計與工程一旦分屬不同公司，出狀況時往往互踢皮球。我們維持同一個團隊：自有的製作工廠與工地管理直接負責施作，專業工班則在我們的監督下進場作業，從動工到完工驗收，現場永遠有人負責到底。', href: './project-engineering-construction', realImg: '/images/engineering-construction-circular-exhibition-hall-with-central-planter-letsuan-design.jpg', alt: '防災教育館 — 中央花圃與展板圍繞的圓形展廳', imgWidth: 700, imgHeight: 383 },
];
