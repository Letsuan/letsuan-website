...
export const featuredProjects = [
  { id: 'serialization-anniversary', title: '名偵探柯南', subtitle: '連載20周年紀念展', category: '展覽', year: '2015–2016', href: './project-serialization-anniversary', realImg: '/images/conan-anniv-kaito-kid-pre-installation-photo-letsuan-design.jpg', alt: '安裝前拍攝的怪盜基德人形立牌，準備固定於屋頂平台', imgWidth: 2160, imgHeight: 3840, objectPosition: 'center 35%' },
  ...
  { id: 'notre-dame', title: '永恆聖母院', subtitle: 'VR沉浸式體驗展臺灣首度亮相', category: '展覽', year: '2023–2024', href: './project-notre-dame', realImg: '/images/notre-dame-vr-users-letsuan-design.jpg', alt: '工作人員協助訪客調整VR頭戴裝置背帶，其他訪客在一旁配戴頭戴裝置', imgWidth: 960, imgHeight: 520 },
