...
export const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitleLine1: 'We design spaces people can walk into and experience,',
    subtitleLine2: 'not spaces meant only to be seen.',
    ctaLabel: 'OUR STORY',
    href: './about',
    particles: {
      count: 108,
  ...
  },
  {
    ...
    subtitleLine1: 'From design to completion,',
    subtitleLine2: 'we hold the same standard throughout.',
    ctaLabel: 'HOW WE WORK',
    href: './what-we-do',
    realImg: '/images/letsuan-hero-slide3-fossil-hall-bg-letsuan-design.jpg',
    bgWidth: 4944,
    bgHeight: 2160,
